  ...
  return (
    <div className="login-page">
      <style jsx>{`
        ...
        .login-logo :global(svg) { width: 36px; height: 36px; }
        .login-title { font-size: 24px; font-weight: 700; color: #0f172a; margin: 0 0 8px 0; }
        .login-subtitle { font-size: 14px; color: #64748b; margin: 0; }
